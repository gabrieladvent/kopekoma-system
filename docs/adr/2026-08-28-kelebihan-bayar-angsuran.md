...
| Implementation | implementer / human | in progress — **SELURUH Key Items selesai** (0a, 1a–1m, 2a–2h, 3a–3r). Sisa murni non-kode: `security-reviewer`, `deploy-reviewer`, dan verifikasi produksi | 2026-08-29 |
