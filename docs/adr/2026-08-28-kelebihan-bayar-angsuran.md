...
| Implementation | implementer / human | in progress — **0a**, **1a**–**1e**, **1g**–**1k** (+ test **3a**, **3h**, **3i**, **3o**) selesai. Seluruh mesin service beres; sisa: kuitansi (1l), pratinjau basi (1f), log (1m), dan pintu UI (2a–2h) | 2026-08-29 |
