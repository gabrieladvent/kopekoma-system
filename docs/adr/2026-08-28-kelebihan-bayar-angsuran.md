...
| Implementation | implementer / human | in progress — **0a** (schema; pelebaran `idempotency_key`), **1a** (saldo turunan + saringan R21), **1b** (tagihan efektif), **1c** (payoff satu sumber; memunculkan R21/OQ-10, ditutup opsi B), **1d** (alokasi bertingkat; mengoreksi batas `k` penjaga pelunasan) selesai | 2026-08-29 |
