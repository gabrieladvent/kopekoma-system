...
| 2 | Titipan Pokok + tutup-sekalian + penjaga Pelunasan Dipercepat aktif | **In Progress** — mesin (1a–1e, 1h, 1k) aktif; pintu UI (2a–2c) belum |
...
- [ ] **Verifikasi produksi (bukan gerbang):** hitung baris angsuran lama yang membayar di atas `total_due` — untuk tahu berapa besar paparan yang dicegah opsi B. Baseline dev 2026-08-28: 0 dari 17
  <!-- source: manual -->
...
| 1m | Perluas properti activity log sesuai tabel Jejak log — **plus tulis payload-nya di bawah kunci yang benar-benar dirender layar** (lihat R22); menulis properti yang tak pernah tampil bukan kontrol, hanya biaya | M | setelah 1e, 1j | Pending |
...
| Implementation | implementer / human | in progress — **0a**, **1a**–**1e**, **1g**–**1l**, **2g** (+ test **3a**, **3h**, **3i**, **3k**, **3o**) selesai. Mesin service, kuitansi, dan label audit beres; sisa: panel riwayat (2e), log (1m + R22), pratinjau basi (1f), dan pintu UI (2a–2f, 2h) | 2026-08-29 |
